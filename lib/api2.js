...
*/
  ...
  const Obj = {
    ...
    Album: {
      ...
      AlbumImages: ['#AlbumBase', '$AlbumKey', '!images', {
        _filter: 'Title,Caption,Keywords,FileName,Date,LastUpdated,ThumbnailUrl,ImageKey,Hidden,Movable,OriginalHeight,OriginalWidth',
        _filteruri: ''
      }],
  ...
  function QueueMultipleJSONforSave (O, dir, aQueue) {
    for (var key in O) {
